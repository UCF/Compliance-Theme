...
Config::$theme_settings = array(
	...
	'Below the Fold' => array(
		...
		new TextField(array(
			'name'        => 'UCF Employee Code of Contact link to be used with the image',
			'id'          => THEME_OPTIONS_NAME.'[ucfcc_link]',
			'description' => 'Link for the image in the UCF Employee Code of Contact area below the fold.  Accepts a standard URL.',
			'value'       => $theme_options['ucfcc_link'],
			'default'	  => '',
		)),
		new TextField(array(
			'name'        => 'UCF Employee Code of Contact Call to Action',
			'id'          => THEME_OPTIONS_NAME.'[ucfcc_cta]',
			'description' => 'Call to Action for UCF Employee Code of Contact area below the fold.',
