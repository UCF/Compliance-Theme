				...
				<?php wp_reset_postdata(); $page_id = get_the_ID(); echo $page_id; $post_objects = get_field('post_objects', $page_id); ?>

				<div id="footer" class="<?php if ( is_page_template( 'single-newsletter.php' ) ) { echo 'newsletter-footer' } elseif( $post_objects_title_check ) { echo 'newsletter-footer' } ?>row">
